...
const acceptOrder = async (assignmentId) => {
  try {
    ...
    console.log("ACCEPT ORDER RESPONSE:", result.data)
    ...
    // refresh active/current order
    await getCurrentOrder()

    // refresh assignments again from backend
  ...
  try {
    console.log("CLICKED MARK AS DELIVERED")
            ...
            {!showOtpBox ? (
              ...
              <div className='mt-4 p-4 border rounded-xl bg-gray-50'>
                <p className='text-sm font-semibold mb-2'>
                  Enter OTP sent to <span className='text-orange-500'>{currentOrder?.customer?.fullName || "Customer"}</span>
                </p>
