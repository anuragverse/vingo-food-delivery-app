...
>
  ...
  {unreadOrderCount > 0 && (
    <span className='absolute -top-2 -right-2 min-w-[20px] h-[20px] px-1 rounded-full bg-red-500 text-white text-xs flex items-center justify-center font-bold'>
      {unreadOrderCount}
    </span>
  )}
</div>
...
>
  ...
  {unreadOrderCount > 0 && (
    <span className='absolute -top-2 -right-2 min-w-[18px] h-[18px] px-1 rounded-full bg-red-500 text-white text-[10px] flex items-center justify-center font-bold'>
      {unreadOrderCount}
    </span>
  )}
</div>
